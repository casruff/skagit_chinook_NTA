...
## ----fit_Ricker_base_show, eval = FALSE, warning = FALSE, cache = FALSE----
...
## ----fit_Ricker_base, echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE----
## params/states to return
par_jags <- c("alpha","E_Rkr_a","mu_Rkr_a",
              "beta",
              "Sp","Rec","tot_ln_Rec","ln_RS",
...
## ----fit_BH_base_show, eval = FALSE, message = FALSE, warning = FALSE, cache = FALSE----
## ## params/states to return
...
## ----fit_BH_base, echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE----
## params/states to return
par_jags <- c("alpha","E_BH_a","mu_BH_a",
              "beta",
              "Sp","Rec","tot_ln_Rec","ln_RS",
...
## ----fit_Ricker_cov_show, eval = FALSE, message = FALSE, warning = FALSE, cache = FALSE----
## ## params/states to return
## par_jags <- c("alpha","E_Rkr_a","mu_Rkr_a",
##               "beta",
##               "gamma",
...
## ----fit_Ricker_cov, echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, eval=TRUE----
## params/states to return
par_jags <- c("alpha","E_Rkr_a","mu_Rkr_a",
              "beta",
              "gamma",
...
## ----fit_BH_cov_show, eval = FALSE, message = FALSE, warning = FALSE, cache = FALSE----
## ## params/states to return
...
## ----fit_BH_cov, echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, eval=TRUE----
## params/states to return
par_jags <- c("alpha","E_BH_a","ln_BH_a",
              "beta",
              "gamma",
...
## ----get_LOOIC_c, warning=FALSE, cache=FALSE------------------------
